...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/kleshat/ZKLAAL/main/File_Bot/commands.lua") 
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'زغلل'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 𝐙𝐊𝐋𝐀𝐋")  
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'زغلل') 
local DRAGON_Msg = { 
...
os.execute('wget https://raw.githubusercontent.com/kleshat/ZKLAAL/main/DRAGON.lua')
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "زغلل")
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/kleshat/ZKLAAL/main/DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/kleshat/ZKLAAL/main/library')
os.execute('wget https://raw.githubusercontent.com/kleshat/ZKLAAL/main/File_Bot')
send(msg.chat_id_, msg.id_,' ◉ تم تحديث السورس')
dofile('DRAGON.lua')  
end
...
[♢ | 𝐙𝐊𝐋𝐀𝐋 𝐓𝐡𝐞 𝐁𝐞𝐬𝐭 𝐒𝐨𝐮𝐫𝐜𝐞 𝐎𝐧 𝐓𝐞𝐥𝐞](t.me/AP_XO)
...
{
{text = '𝐒𝐨𝐮𝐫𝐜𝐞 𝐏𝐫𝐨𝐠𝐫𝐚𝐦𝐦𝐞𝐫𝐬', url = "https://t.me/AP_XO"},
},
{
{text = '𝐂𝐇𝐀𝐍𝐍𝐄𝐋 𝐙𝐊𝐋𝐀𝐋', url = "https://t.me/AP_XO"}
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/hdhsjuei/2?single&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text == '•═════•〈〈ＺＫＬＡＬ 〉〉•═════•' or text == '•═════•〈〈ＺＫＬＡＬ 〉〉•═════•' or text == '•═════•〈〈ＺＫＬＡＬ 〉〉•═════•' or text == '"' then
local Text =[[
...
if text == "صاحب البوت" and SudoBot(msg) or text == "مين المبرمج" and SudoBot(msg) then 
if not DevSoFi(msg) then
...
if text == "المنيل" or text == "منيل" then
local TEXT_SUD = database:get(bot_id..'Tshake:TEXT_SUDO')
if TEXT_SUDO then 
send(msg.chat_id_, msg.id_,TEXT_SUDO)
else
tdcli_function ({ID = "GetUser",user_id_ =  1986403229,},function(arg,result) 
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = 'للتواصل مع المنيل مبرمج السورس اتبع الازرار ♡\n['..result.first_name_..'](t.me/MANIAL_XBLACK)\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '  ❨  '..result.first_name_..'  ❩ ',url="t.me/"..result.username_},
...
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ =  1986403229, offset_ = 0, limit_ = 1 }, taha, nil)
end,nil)
end
end
...
tdcli_function ({ID = "GetUser",user_id_ =  1885706669,},function(arg,result) 
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = 'للتواصل مع زغلل مبرمج السورس اتبع الازرار ♡\n['..result.first_name_..'](t.me/M_ahmu_d)\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '  ❨  '..result.first_name_..'  ❩ ',url="t.me/"..result.username_},
...
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ =  1885706669, offset_ = 0, limit_ = 1 }, taha, nil)
end,nil)
end
end

if text == "عم اشرف" or text == "اشرف الصعيدي" or text == "كبير التلي" or text == "عمو اشرف" then
local TEXT_SUD = database:get(bot_id..'Tshake:TEXT_SUDO')
if TEXT_SUDO then 
send(msg.chat_id_, msg.id_,TEXT_SUDO)
else
tdcli_function ({ID = "GetUser",user_id_ =  1635597460,},function(arg,result) 
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = 'للتواصل مع عمو اشرف الصعيدي اتبع الازرار الاتيه ♡\n['..result.first_name_..'](t.me/asera126)\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '  ❨  '..result.first_name_..'  ❩ ',url="t.me/"..result.username_},
...
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ =  1635597460, offset_ = 0, limit_ = 1 }, taha, nil)
end,nil)
end
end
...
if text == 'العاب زغلل' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/wffhvvv/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/bebo44yy/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ffadi88/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'\n◉تم قفل البوتات بالطرد\n◉تم وضع الايدي بدون صوره\n◉تم قفل التكرار بالطرد\n◉تم قفل الروابط\n◉تم قفل التوجيه\n◉تم قفل الملصقات\n◉تم قفل المتحركه\n◉تم قفل الفيديو\n◉تم قفل السب\n◉تم قفل التعديل\n◉تم قفل الفارسيه\n◉تم قفل التفليش\n\nتم تفعيل الحمايه بواسطه ←['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'AP_XO ')..')')   
end,nil) 
end
--------------------------------------------------------------------------------------------------------------
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/kleshat/ZKLAAL/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/kleshat/ZKLAAL/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ◉ عذرا الملف لايدعم سورس زغلل \n") 
end
return false
end
...
if text == ("مسح قائمه زغلل") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ◉ تم مسح قائمه زغلل')
return false
end

if text == 'قائمه زغلل' and Sudo(msg) then
...
if text == ("رفع زغلل") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local AP_XO  = database:get(bot_id..'text:ch:user')
if AP_XO  then
send(msg.chat_id_, msg.id_,'['..AP_XO ..']')
...
if text and text:match("^رفع زغلل @(.*)$") and Sudo(msg) then
local username = text:match("^رفع زغلل @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local AP_XO  = database:get(bot_id..'text:ch:user')
if AP_XO  then
send(msg.chat_id_, msg.id_,'['..AP_XO ..']')
...
if text and text:match("^رفع زغلل (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع زغلل (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local AP_XO  = database:get(bot_id..'text:ch:user')
if AP_XO  then
send(msg.chat_id_, msg.id_,'['..AP_XO ..']')
...
if text == ("تنزيل زغلل") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local AP_XO  = database:get(bot_id..'text:ch:user')
if AP_XO  then
send(msg.chat_id_, msg.id_,'['..AP_XO ..']')
...
if text and text:match("^تنزيل زغلل @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل زغلل @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local AP_XO  = database:get(bot_id..'text:ch:user')
if AP_XO  then
send(msg.chat_id_, msg.id_,'['..AP_XO ..']')
...
if text and text:match("^تنزيل زغلل (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل زغلل (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local AP_XO  = database:get(bot_id..'text:ch:user')
if AP_XO  then
send(msg.chat_id_, msg.id_,'['..AP_XO ..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ◉ العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'AP_XO')..')'
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝐂𝐇𝐀𝐍𝐍𝐄𝐋 𝐙𝐊𝐋𝐀𝐋', url="t.me/AP_XO "}},
{{text = 'اضف البوت لمجموعتك 𖠕', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
end --الكود حصري سورس زغلل يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'زغلل').." غادر" or text == 'غادر' then  
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/AP_XO)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
send(msg.chat_id_,msg.id_, 'اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه زغلل') 
return false
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'زغلل').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'زغلل')
local DRAGON_Msg = {
'نعم يروحي♥️🙈',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
'دوختو  '..Namebot..'',
'انت تعرف انو بوت  '..Namebot..'  متنصب علي سورس زغلل🙈♥️',
'بتشقط وجي ويت 🤪',
'ايوا جاي 🙈',
'يعم هتسحر واجي 😾',
